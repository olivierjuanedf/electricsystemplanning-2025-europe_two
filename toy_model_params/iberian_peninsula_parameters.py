    ...
    generators = [
        {
            ...
            GEN_UNITS_PYPSA_PARAMS.marginal_cost: fuel_sources[FuelNames.uranium].primary_cost / 1,
...

        {
            ...
            GEN_UNITS_PYPSA_PARAMS.max_hours: 1058.3,
            GEN_UNITS_PYPSA_PARAMS.soc_init: 0,
       ...
       # },
        ...
        },
        {
            ...
            GEN_UNITS_PYPSA_PARAMS.carrier: FuelNames.wind,
            GEN_UNITS_PYPSA_PARAMS.nominal_power: 3190,
        ...
        },
        {
        ...
        },
          {
            ...
            GEN_UNITS_PYPSA_PARAMS.carrier: FuelNames.solar,
            GEN_UNITS_PYPSA_PARAMS.nominal_power: 4185.5,
            GEN_UNITS_PYPSA_PARAMS.max_power_pu: solar_pv_cf_data['value'].values,
            GEN_UNITS_PYPSA_PARAMS.marginal_cost: fuel_sources[FuelNames.solar].primary_cost
        },
        {
