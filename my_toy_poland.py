# -*- coding: utf-8 -*-
"""
First very simple toy Unit Commitment (UC) model of Poland zone - alone -> with PyPSA and ERAA data
...
"""
  IV) Build PyPSA model - with unique country (Poland here)
    ...
    toy_model_params/poland_parameters.py
...
# -> from toy_model_params/poland_parameters.py script
...
if optim_status == pypsa_opt_resol_status:
    ...
    # saved in file output/long_term_uc/monozone_ita/figures/prod_poland_{year}_{period start, under format %Y-%m-%d}.png
    ...
    # -> saved in file output/long_term_uc/monozone_ita/figures/prices_poland_{year}
